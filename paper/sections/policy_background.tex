...
\end{tikzpicture}
\caption[EU~ETS institutional timeline]{EU~ETS institutional timeline. The four trading phases, main regulatory events, and the proposed sample window (2005--2021). Institutional facts only; no price data plotted.\\

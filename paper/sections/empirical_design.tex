...
Magnitude would need its own benchmark, since statistical precision alone would not establish that an effect mattered. \citet{bellora2023} simulate that replacing free allocation with the CBAM reduces leakage by 34 to 42 per cent. A corridor response of comparable order would be economically meaningful. A response moving corridor import value by well under one per cent would not be, however precisely it were estimated.

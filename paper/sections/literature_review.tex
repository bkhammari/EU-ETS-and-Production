...
\midrule
\citet{naegele2019} & Embodied-carbon trade flows, GTAP data, 2004--2011 & Net-flow and bilateral regressions using the EU~ETS emission cost net of free allocation & No evidence of trade-flow leakage & Stringency never interacted with partner regulatory status, sample ends 2011 \\
\addlinespace

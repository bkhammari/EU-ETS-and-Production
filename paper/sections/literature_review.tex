...
Two features common to the samples fit the pattern better. The first is the treatment itself. Every study covers years in which the effective carbon cost was close to zero, so the nulls are informative about a weak treatment rather than about an inelastic response to a strong one. The second is the margin measured. Installation-level records contain no import flows, so the finding that emissions fell without a loss of value added, as in \citet{colmer2025} and \citet{dechezlepretre2023}, identifies abatement and is silent on sourcing. Where effects do surface, they surface where free allocation does not reach, on the mobility margin in \citet{koch2019} and in the cross-country Kyoto variation exploited by \citet{aichele2015}.
